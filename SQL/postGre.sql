SELECT VERSION();
	...
	VALUES ('Jon Smith', 36, 26500 );
	
	Select * from Employee;
	
	INSERT INTO Employee (Name, Age, Salary)
	VALUES ('Helen Mirren', 22, 21000);
	
	-- Characters are kept in '', and next row values are seperated using ,.
	INSERT INTO Employee (Name, Age, Salary)
	VALUES ('David Cameron', 29, 39000),
	('Brad Pitt', 52, 45000);
	...
	INSERT INTO Employee (Name, Age, Salary)
	VALUES ('Anna Starolsky', 41, 22500),
	('Peter Piper', 20, 31500),
	('David Duck', 19, 15700),
	('Julie Walters', 33, 19000);
	
	
	Select * from Employee;
	
	INSERT INTO Employee (Name, Age, Salary)
	VALUES ('Johnson Baby', 27, 18000),
	('Harding Hatar', 28, 52000),
	('Hoover Mann', 32, 37000),
	('Lincoln Genare', 21, 22500),
	('Polk Bhesk', 41, 75000),
	('Adams Apple', 54, 91000);
...
SELECT Name, Salary FROM Employee;
		...
		Add Service_period int;
		
		Select * from Employee;
		
		Update Employee
		Set Service_period = 10
		Where salary = 26500;
		
		Select * from Employee;
		
		Update Employee
		Set Service_period = 1, Age = 21
		Where Name = 'Helen Mirren';
		
		Select * from Employee;
		
		Alter Table Employee
		Alter Column Service_period TYPE Char(9);
		...
		Update Employee
		Set Service_period='10 Years'
		Where name ='Jon Smith';
		
		Select * from Employee;
		
		Update Employee
		Set Service_period = '1 Year'
		Where age = 21;
		...
		where name = 'Johnson Baby';
		
		Select * from Employee;
		
		/*Delete/Truncate - Used to Delete all data from table
		
		Delete From Employee;
		Truncate Table Employee;*/
		
		/* Drop - used to delete table itself or database.
...
-- model start with a 'J':
select * from testproducts
WHERE product_name iLIKE 'J%'; 

select * from testproducts
WHERE product_name NOT iLIKE 'J%'; 
...
---------------------------------------------------------------------------------
  select * from testproducts
WHERE category_id BETWEEN 9 AND 12;

  select * from testproducts
WHERE category_id NOT BETWEEN 9 AND 12;
----------------------------------------------------------------------

-- IN operator is a shorthand for multiple OR conditions.
  Select * from testproducts
WHERE category_id IN (2,4,8);  

  Select * from testproducts
WHERE category_id NOT IN (2,4,8); 
-------------------------------------------------------------------------------
Select * from testproducts
...
Select product_name from testproducts;
  Select * from testproducts;
 ...
 ---------------------------------------------------------------------- 
  Select * from testproducts
  where testproduct_id = 9 ;
  
    Select * from testproducts
  where testproduct_id >3 ;
  
    Select * from testproducts
  where testproduct_id < 7;
----------------------------------------------------------------------  
    Select * from testproducts
 ...
 ----------------------------------------------------------------- 
  ...
  select * from testproducts;
  select min(category_id) from testproducts;
  select min(category_id) as Chota from testproducts;
  
    select max(category_id) from testproducts;
	  select max(category_id) as bada from testproducts;
--------------------------------------------------------------------------

select * from testproducts;

select count(testproduct_id) from testproducts;
...
SELECT avg(category_id)::numeric(10,2)
FROM testproducts;
...
SELECT * FROM testproducts
WHERE testproduct_id BETWEEN 1 AND 5;

SELECT * FROM testproducts
WHERE product_name BETWEEN 'Jims Secret Recipe' AND 'Mias Popular Ice';
------------------------------------------
select * from testproducts;

select testproduct_id as ID
from testproducts;

select testproduct_id ID1
from testproducts;

select testproduct_id || product_name AS Name
FROM testproducts; 
